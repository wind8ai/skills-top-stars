...
- [skills](#8-microsoftskills-27k-) — Microsoft 官方出品，SDK 用的 Skills、MCP servers、Custom Agents

### 🤖 Agent 工作流与方法论

- [darwin-skill](#1-alchaincyfdarwin-skill-45k-) — 达尔文.skill —— 让所有 Skill 自主进化的系统

### 📦 领域 Skills 合集

- [axton-obsidian-visual-skills](#6-axtonliuaxton-obsidian-visual-skills-31k-) — Obsidian 可视化 skills，生成 Canvas/Excalidraw/Mermaid 图表
...
- [skills](#4-browser-actskills-34k-) — 浏览器自动化 CLI，为 AI agent 构建，支持多任务并行，突破反爬机制，跨平台人工交接
- [chrome-cdp-skill](#5-paskychrome-cdp-skill-31k-) — 让 AI agent 直接接管已打开的 Chrome 标签页，CDP 协议实现
...
- 本文件收录 Star List 中 **tier = overflow** 的 eligible 条目（已 star、Star ≥ 500、未进入正式榜前 42）
