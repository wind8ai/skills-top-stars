...
01. [Dimillian/Skills (3.8k ⭐)](#1-dimillianskills-38k-)
02. [google-gemini/gemini-skills (3.8k ⭐)](#2-google-geminigemini-skills-38k-)
03. [browser-act/skills (3.5k ⭐)](#3-browser-actskills-35k-)
04. [pasky/chrome-cdp-skill (3.1k ⭐)](#4-paskychrome-cdp-skill-31k-)
05. [axtonliu/axton-obsidian-visual-skills (3.1k ⭐)](#5-axtonliuaxton-obsidian-visual-skills-31k-)
...
10. [Kappaemme-git/codex-startup-pressure-test-skill (964 ⭐)](#10-kappaemme-gitcodex-startup-pressure-test-skill-964-)
11. [warpdotdev/oz-skills (816 ⭐)](#11-warpdotdevoz-skills-816-)
12. [imxv/Pretty-mermaid-skills (763 ⭐)](#12-imxvpretty-mermaid-skills-763-)

---

## 1. Dimillian/Skills (3.8k ⭐)
...
## 2. google-gemini/gemini-skills (3.8k ⭐)
...
## 5. axtonliu/axton-obsidian-visual-skills (3.1k ⭐)
...
## 10. Kappaemme-git/codex-startup-pressure-test-skill (964 ⭐)
...
## 12. imxv/Pretty-mermaid-skills (763 ⭐)
...
- [skills](#7-microsoftskills-27k-) — Microsoft 官方出品，SDK 用的 Skills、MCP servers、Custom Agents

### 📦 领域 Skills 合集

- [axton-obsidian-visual-skills](#5-axtonliuaxton-obsidian-visual-skills-31k-) — Obsidian 可视化 skills，生成 Canvas/Excalidraw/Mermaid 图表

### 🔧 工具与质量

- [Skills](#1-dimillianskills-38k-) — Dimillian 的个人 Codex Skills 集合，Shell 实现
- [gemini-skills](#2-google-geminigemini-skills-38k-) — Gemini API、SDK 和 model/agent 交互的 Skills
- [skills](#3-browser-actskills-35k-) — 浏览器自动化 CLI，为 AI agent 构建，支持多任务并行，突破反爬机制，跨平台人工交接
- [chrome-cdp-skill](#4-paskychrome-cdp-skill-31k-) — 让 AI agent 直接接管已打开的 Chrome 标签页，CDP 协议实现
...
- [codex-startup-pressure-test-skill](#10-kappaemme-gitcodex-startup-pressure-test-skill-964-) — Codex 创业点子压力测试 Skill：对 startup idea 做创始人式诊断，输出 verdict、核心假设、…
- [oz-skills](#11-warpdotdevoz-skills-816-) — Warp AI / Oz 的可复用 Agent Skills 精选集：以 .agents/skills/ 下的 Mark…
- [Pretty-mermaid-skills](#12-imxvpretty-mermaid-skills-763-) — 为 AI agent 提供 Mermaid 图表渲染能力的 Skill，支持 SVG 与 ASCII 两种输出格式
