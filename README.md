...
| # | 项目 | 链接 | 星数 | 说明 |
|---|------|------|------|------|
| 1 | lijigang/ljg-skills | https://github.com/lijigang/ljg-skills | 5.5k ⭐ | 个人 skills 集合，涵盖闪卡、学习、论文、写作等中文场景 |
...
| 6 | axtonliu/axton-obsidian-visual-skills | https://github.com/axtonliu/axton-obsidian-visual-skills | 3.0k ⭐ | Obsidian 可视化 skills，生成 Canvas/Excalidraw/Mermaid 图表 |
...
| 10 | browser-act/skills | https://github.com/browser-act/skills | 1.7k ⭐ | 浏览器自动化 CLI，为 AI agent 构建，支持多任务并行 |
| 11 | wuji-labs/nopua | https://github.com/wuji-labs/nopua | 1.3k ⭐ | 用爱解放 AI 潜能的 Skill，以关怀替代威胁，提升 AI 输出质量 |
| 12 | Kappaemme-git/codex-startup-pressure-test-skill | https://github.com/Kappaemme-git/codex-startup-pressure-test-skill | 897 ⭐ | Codex 创业压力测试 Skill，JavaScript 实现 |
| 13 | warpdotdev/oz-skills | https://github.com/warpdotdev/oz-skills | 805 ⭐ | Warp 团队出品的 agent skills，Python 实现 |
...
| 18 | YouMind-OpenLab/skills | https://github.com/YouMind-OpenLab/skills | 51 ⭐ | YouMind 的 Claude Code skills，TypeScript 实现 |
