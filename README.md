...
| 2 | axtonliu/axton-obsidian-visual-skills | https://github.com/axtonliu/axton-obsidian-visual-skills | 2.1k ⭐ | Obsidian 可视化 skills，生成 Canvas/Excalidraw/Mermaid 图表 |
| 3 | microsoft/skills | https://github.com/microsoft/skills | 2k ⭐ | Microsoft 官方出品，SDK 用的 Skills、MCP servers、Custom Agents |
| 4 | cisco-ai-defense/skill-scanner | https://github.com/cisco-ai-defense/skill-scanner | 1.7k ⭐ | Cisco 出品，Agent Skills 安全扫描器 |
| 5 | imxv/Pretty-mermaid-skills | https://github.com/imxv/Pretty-mermaid-skills | 613 ⭐ | Mermaid 图表渲染能力，支持 SVG 和 ASCII 输出 |
| 6 | ZhangHanDong/harness-engineering-from-cc-to-ai-coding | https://github.com/ZhangHanDong/harness-engineering-from-cc-to-ai-coding | 534 ⭐ | 从 Claude Code 源码到 AI Coding 的 Harness Engineering 解析 |
